...
async function createUser(ownerID, appName, username, password, expiry) {
...
module.exports = {
  testCredentials,
  generateKey, fetchKeys, deleteKey, banKey, unbanKey, verifyKey,
  fetchUsers, banUser, unbanUser, deleteUser, resetUser, createUser,
  fetchLogs,
  getDashboardSummary,
};
